...
import com.davidcurbelo.vetpetproyectodam.cliente.MyAdapterConsultasAbiertas;
...
public class pantalla_consultas_cerradas_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla_consultas_cerradas_admin);

        toolbar = this.findViewById(R.id.toolbar_consultas_cerradas_admin);
        setSupportActionBar(toolbar);
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        constraintLayout = this.findViewById(R.id.layout_consultas_cerradas_admin);

        mAuth = FirebaseAuth.getInstance();
        user = mAuth.getCurrentUser();
        mDatabase = FirebaseDatabase.getInstance().getReference();

        rvConsultas = this.findViewById(R.id.recyclerview_consultas_cerradas_admin);
        rvConsultas.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(this);
        rvConsultas.setLayoutManager(layoutManager);
        consultas = new ArrayList<>();
        consulta = new ArrayList<>();
        adapter = new MyAdapterConsultasCerradasAdmin(consultas, consulta, getApplicationContext());
    }
    ...
    public void loadAdapter(){
        getIdClinicaFromFirebase(new idCallback() {
            ...
            public void onCallback(String id_clinica) {
                ...
                // Obtener todos los datos de las consultas de la clínica
                        ...
                        for(int i = 1; i <= num_consultas; i++){
                            ...
                            ref_consultas.child(String.valueOf(i)).addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    ...
                                    // Obtener el estado de la consulta para mostrar solamente las consultas cerradas
                                    ...
                                    if(estado.equalsIgnoreCase("Cerrada")){
                                        ...
                                        getImagenMascotaFromFirebase(new idCallback() {
                                            ...
                                            public void onCallback(String id) {
                                                ...
                                                // Si hay consultas cerradas, se cambia el fondo predeterminado por un color

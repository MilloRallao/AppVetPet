...
public class MyAdapterConsultasAbiertasAdmin extends RecyclerView.Adapter<MyAdapterConsultasAbiertasAdmin.MyViewHolder>  {
    private static List<List<Object>> consultas;
    private List<Object> consulta;
    private Context contexto;

    MyAdapterConsultasAbiertasAdmin(List<List<Object>> myDataset1, List<Object> myDataSet2, Context context) {
        contexto = context;
    ...
    @NonNull
    @Override
    public MyAdapterConsultasAbiertasAdmin.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.consultas_abiertas_cardview, parent, false);
        return new MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull MyAdapterConsultasAbiertasAdmin.MyViewHolder holder, int position) {

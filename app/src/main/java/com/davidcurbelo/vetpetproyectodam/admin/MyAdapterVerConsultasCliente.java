...
public class MyAdapterVerConsultasCliente extends RecyclerView.Adapter<MyAdapterVerConsultasCliente.MyViewHolder> {
    private static List<List<Object>> consultas;
    private List<Object> consulta;
    private Context contexto;

    MyAdapterVerConsultasCliente(List<List<Object>> myDataset1, List<Object> myDataSet2, Context context) {
        contexto = context;
    ...
    @NonNull
    @Override
    public MyAdapterVerConsultasCliente.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.consultas_abiertas_cardview, parent, false);
        return new MyViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull MyAdapterVerConsultasCliente.MyViewHolder holder, int position) {
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        MyViewHolder(View v) {
            ...
            cardView = v.findViewById(R.id.cardview_consultas_abiertas);
            id = v.findViewById(R.id.textView_id_consultas_abiertas);
            imagen = v.findViewById(R.id.imageView_mascota_consultas_abiertas);
            fecha = v.findViewById(R.id.textView_fecha_consultas_abiertas);
            nombre = v.findViewById(R.id.textView_nombre_mascota_consultas_abiertas);
            asunto = v.findViewById(R.id.textView_asunto_consultas_abiertas);
            adjuntos = v.findViewById(R.id.textView_adjuntos_consultas_abiertas);
            respuesta = v.findViewById(R.id.textView_respuestas_consultas_abiertas);
            icono = v.findViewById(R.id.imageView_icono_respuesta_consultas_abiertas);
            ver = v.findViewById(R.id.imageButton_ver_consulta_consultas_abiertas);

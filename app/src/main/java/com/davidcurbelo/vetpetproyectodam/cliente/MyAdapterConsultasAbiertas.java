...
public class MyAdapterConsultasAbiertas extends RecyclerView.Adapter<MyAdapterConsultasAbiertas.MyViewHolder> {
    private static List<List<Object>> consultas;
    private List<Object> consulta;
    private Context contexto;

    MyAdapterConsultasAbiertas(List<List<Object>> myDataset1, List<Object> myDataSet2, Context context) {
        contexto = context;
    ...
    @NonNull
    @Override
    public MyAdapterConsultasAbiertas.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

...
public class pantalla_historial_citas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla_historial_citas);

        toolbar = this.findViewById(R.id.toolbar_historial_citas);
        ...
        rvCitas = this.findViewById(R.id.recyclerview_historial_citas);
        rvCitas.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(this);
        rvCitas.setLayoutManager(layoutManager);
        citas = new ArrayList<>();
        cita = new ArrayList<>();
        adapter = new MyAdapterHistorialCitas(citas, cita, getApplicationContext());
            ...
            public void onCallback(String id) {
                ...
                ref_citas.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange (@NonNull DataSnapshot dataSnapshot){
                        // Recorrer todas las citas del usuario en "citas" y establecer el Adapter para el RecyclerView para ir mostrandolas
                        for(int i = 1; i <= num_citas; i++){
                            ...
                            // Obtener el estado de la cita para mostrar solamente las citas realizadas o canceladas

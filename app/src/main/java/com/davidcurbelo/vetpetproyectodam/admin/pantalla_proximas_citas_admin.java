...
public class pantalla_proximas_citas_admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla_proximas_citas_admin);

        toolbar = this.findViewById(R.id.toolbar_proximas_citas_admin);
        setSupportActionBar(toolbar);
        this.getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        constraintLayout = this.findViewById(R.id.layout_proximas_citas_admin);

        mAuth = FirebaseAuth.getInstance();
        user = mAuth.getCurrentUser();
        mDatabase = FirebaseDatabase.getInstance().getReference();

        rvCitas = this.findViewById(R.id.recyclerview_proximas_citas_admin);
        rvCitas.setHasFixedSize(true);
        layoutManager = new LinearLayoutManager(this);
        rvCitas.setLayoutManager(layoutManager);
        citas = new ArrayList<>();
        cita = new ArrayList<>();
        adapter = new MyAdapterCitasAdmin(citas, cita, getApplicationContext(), 1);
    ...
    // Llamar al adaptador del RecyclerView con los datos de las próximas citas de la clinica
            ...
            public void onCallback(String id_clinica) {
                ...
                ref_citas.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Query query = ref_citas.orderByChild("timestamp").startAt(date.getTime());
                                ...
                                for(final DataSnapshot ds : dataSnapshot.getChildren()) {
                                    ...
                                    getImagenMascotaFromFirebase(new idCallback() {
                                        ...
                                        public void onCallback(String foto) {
                                            ...
                                            // Si hay citas próximas, se cambia el fondo predeterminado por un color

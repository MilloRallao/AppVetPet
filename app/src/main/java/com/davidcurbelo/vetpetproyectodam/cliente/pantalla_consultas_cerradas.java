...
public class pantalla_consultas_cerradas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla_consultas_cerradas);

        toolbar = this.findViewById(R.id.toolbar_consultas_cerradas);
        ...
        rvConsultas = this.findViewById(R.id.recyclerview_consultas_cerradas);
        ...
        adapter = new MyAdapterConsultasCerradas(consultas, consulta, getApplicationContext());
        ...
        getIdClinicaFromFirebase(new idCallback() {
            ...
            public void onCallback(String id) {
                ...
                ref_consultas.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange (@NonNull DataSnapshot dataSnapshot){
                        // Recorrer todas las consultas del usuario en "consultas" y establecer el Adapter para el RecyclerView para ir mostrandolas
                        for(int i = 1; i <= num_consultas; i++){

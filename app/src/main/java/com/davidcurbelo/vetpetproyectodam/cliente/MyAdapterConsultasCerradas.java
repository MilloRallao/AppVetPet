...
public class MyAdapterConsultasCerradas extends RecyclerView.Adapter<MyAdapterConsultasCerradas.MyViewHolder> {
    private static List<List<Object>> consultas;
    private List<Object> consulta;
    private Context contexto;

    MyAdapterConsultasCerradas(List<List<Object>> myDataset1, List<Object> myDataSet2, Context context) {
        contexto = context;
    ...
    @NonNull
    @Override
    public MyAdapterConsultasCerradas.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
